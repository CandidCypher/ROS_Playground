...
struct HardwareStatus_
{
  ...
  _are_motors_up_type are_motors_up;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _debug_msg_type;
...
struct MD5Sum< ::my_robot_msgs::HardwareStatus_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x16c9db7011617520ULL;
  static const uint64_t static_value2 = 0xb4a5c142182c234cULL;
};
...
struct Printer< ::my_robot_msgs::HardwareStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_robot_msgs::HardwareStatus_<ContainerAllocator>& v)
  {
    ...
    s << indent << "debug_msg: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.debug_msg);
  }
};
